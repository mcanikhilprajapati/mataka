...
import com.instantonlinematka.instantonlinematka.view.activity.games.market.gametypes.SingleGameActivity
import kotlinx.android.synthetic.main.item_game_points.view.*

class SingleGameAdapter(
    val context: Context,
    var singleGameList: ArrayList<GameDataList>,
    val singleGameActivity: SingleGameActivity
) :
    RecyclerView.Adapter<SingleGameAdapter.GamesViewHolder>() {
    ...
    override fun onBindViewHolder(holder: GamesViewHolder, position: Int) {
        ...
        holder.GameNumber.text = data.numbers
