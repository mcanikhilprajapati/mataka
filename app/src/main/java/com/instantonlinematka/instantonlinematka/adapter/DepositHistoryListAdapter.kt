...
class DepositHistoryListAdapter(val context: Context, val gameList: ArrayList<Data>) :
    RecyclerView.Adapter<DepositHistoryListAdapter.GameHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GameHolder {
        ...
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.list_item_deposit_history, parent, false)
    ...
    override fun onBindViewHolder(holder: GameHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.lblStatus.text = gameData.status
