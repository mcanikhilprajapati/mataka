...
import com.instantonlinematka.instantonlinematka.adapter.JodiGameAdapter
...
import kotlinx.android.synthetic.main.activity_jodi_game.*
...
class JodiGameActivity : AppCompatActivity() {
    ...
    lateinit var adapter: JodiGameAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = JodiGameAdapter(context, numberList, this@JodiGameActivity)
        ...
        btnProceed.setSafeOnClickListener {
            ...
            for (data in numberList) {
                ...
                if (data.points != 0) {
                    ...
                    if (data.numbers.toInt() < 10) {
                        FinalPointList.add(GameDataList("0${data.numbers.toInt()}", data.points))
                    }
                    else {
                        FinalPointList.add(GameDataList("${data.numbers.toInt()}", data.points))
                    }
                }
            }
            ...
            if (FinalPointList.size == 0) {
                ...
                val mBottomSheetDialog: BottomSheetMaterialDialog =
                    BottomSheetMaterialDialog.Builder(this@JodiGameActivity)
                ...
                btnSubmitButton.setSafeOnClickListener {
                    ...
                    if (Connectivity.isOnline(context)) {
                        makeRequest(btnCancel, btnSubmitButton, wp10progressBar2, mBottomSheetDialog)
                    }
                    else {
    ...
    fun makeGameDataApiCall() {
        ...
        call.enqueue(object : Callback<GameDataResponse> {
            ...
            override fun onFailure(call: Call<GameDataResponse>, t: Throwable) {
                ...
                val mBottomSheetDialog: BottomSheetMaterialDialog =
                    BottomSheetMaterialDialog.Builder(context as JodiGameActivity)
                        .setTitle(getString(R.string.uhoh))
