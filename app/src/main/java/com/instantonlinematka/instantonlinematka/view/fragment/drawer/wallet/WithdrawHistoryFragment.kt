...
import com.instantonlinematka.instantonlinematka.adapter.WithdrawHistoryListAdapter
...
import com.instantonlinematka.instantonlinematka.databinding.WithdrawHistoryFragmentBinding
...
class WithdrawHistoryFragment : Fragment() {
    ...
    lateinit var binding: WithdrawHistoryFragmentBinding
    ...
    lateinit var adapter: WithdrawHistoryListAdapter
    ...
    override fun onCreateView(
        ...
        binding = WithdrawHistoryFragmentBinding.inflate(inflater, container, false)
        ...
        adapter = WithdrawHistoryListAdapter(contextMarket, gameList)
...
//        }
    ...
    fun getWithdrawHistoryList() {

        if (Connectivity.isOnline(contextMarket)) {
            getWithdrawHistoryListApiCall()
        }
        else {
    ...
    fun getWithdrawHistoryListApiCall() {
        ...
        val call = apiInterface.getDepositHistoryList(sessionPrefs.getString(Constants.USER_ID),"withdrawal_fund")
